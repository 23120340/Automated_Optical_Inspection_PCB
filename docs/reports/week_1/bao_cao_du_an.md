...
> **Tài liệu tham chiếu:** Thiết kế hệ thống, Thực nghiệm mã nguồn ([`aoi_pipeline/`](../../../aoi_pipeline)), Báo cáo tiến độ ([`docs/reports/bao_cao_tien_do.md`](../bao_cao_tien_do.md)), Hướng dẫn huấn luyện ([`training/kaggle/`](../../../training/kaggle)), và Nghiên cứu phân cực linh kiện.  
