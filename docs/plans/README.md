# ke_hoach — Sẽ làm gì, và vì sao làm thế

- **[roadmap_status.md](roadmap_status.md)** — trạng thái tất cả kế hoạch: cái gì xong, cái gì dở, cái gì mới trên giấy. Đọc cái này trước.
- [ke_hoach_ban_giao_5_5_va_6_2.md](ke_hoach_ban_giao_5_5_va_6_2.md)
- [ke_hoach_detect_moi_han_2_giai_doan.md](ke_hoach_detect_moi_han_2_giai_doan.md)
- [ke_hoach_fine_tune_cuc_bo.md](ke_hoach_fine_tune_cuc_bo.md)
...
- [phuong_an_sua_roi_moi_han.md](phuong_an_sua_roi_moi_han.md)
- [phuong_an_sua_roi_moi_han_v2.md](phuong_an_sua_roi_moi_han_v2.md)
