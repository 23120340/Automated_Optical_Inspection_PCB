...
> Tài liệu liên quan: [Kế hoạch phân loại 6.1](ke_hoach_pretrain_6_1_classification.md) | [Kế hoạch số hóa PCB](ke_hoach_so_hoa_mach_pcb_aoi.md) | [Định dạng CAD](../design/cad_formats.md)
