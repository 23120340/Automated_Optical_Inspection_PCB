...
`docs/design/yeu_cau_phan_cung_camera.md` có 46 µm/px và FOV mục tiêu, nhưng
...
Bảng đã có ở mục 3.2 của `docs/design/yeu_cau_phan_cung_camera.md`, đã trừ 15% chồng
...
Xem thêm: `docs/design/yeu_cau_phan_cung_camera.md` (46 µm/px, FOV, số khung
chụp) · `docs/plans/ke_hoach_so_hoa_mach_pcb_aoi.md` (sơ đồ → CAD/netlist,
