...
Thiết kế tọa độ phải tuân theo [Position Check và Golden Compare](../design/thiet_ke_position_va_golden_compare.md) cùng [chỉ dẫn repository](../../AGENTS.md). Các mô tả hiện trạng cũ trong tài liệu thiết kế phải được đối chiếu lại với code khi triển khai.
