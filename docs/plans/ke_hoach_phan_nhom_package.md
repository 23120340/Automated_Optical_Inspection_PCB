...
Chi tiết ở [đánh giá 6.1 §7](../evaluation/danh_gia_classifier_6_1.md).
...
[danh_gia_classifier_6_1.md](../evaluation/danh_gia_classifier_6_1.md).
...
Xem thêm: `docs/reports/tien_do_detect_2_luot.md` (bảng công việc sống),
`docs/evaluation/danh_gia_khoanh_box_than_linh_kien.md` (báo cáo box),
`docs/plans/ke_hoach_pcb_defect_toan_mach.md` (kế hoạch lỗi toàn mạch).
