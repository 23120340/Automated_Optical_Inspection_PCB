...
board của chính dây chuyền (C1–C3 trong `docs/reports/tien_do_detect_2_luot.md`) vẫn là
...
`docs/design/yeu_cau_phan_cung_camera.md`: kiểm tra fillet cần 15–25 µm/px, và hàn nguội
