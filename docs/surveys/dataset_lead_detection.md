...
> Soạn 2026-08-21. Khác với `docs/surveys/pcb_aoi_component_datasets.md` (khảo sát nguồn
...
Chi tiết ở `docs/surveys/khao_sat_model_huggingface.md`. **Kết luận đã được sửa trong
