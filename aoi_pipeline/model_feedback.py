...
bộ máy với :mod:`aoi_pipeline.evidence`, chỉ khác chủ thể: `evidence` ghi lỗi
...
from .evidence import DefectEvidence, EvidenceBundle, SourceFingerprint
...
def feedback_root() -> Path:
    ...
    return Path(__file__).resolve().parents[1] / "feedback"
...
def evidence_bundle_for(
    ...
    :mod:`aoi_pipeline.evidence`. Ở đây chỉ ánh xạ sang đúng hình dạng đó, nên
