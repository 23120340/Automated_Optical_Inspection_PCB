...
Triển khai Position Check và Golden Compare theo `context.md` cho dự án `Automated_Optical_Inspection_PCB`.
...
Nếu code hiện tại đã khác `context.md`, ưu tiên code thực tế và báo rõ khác biệt trước khi thay đổi kiến trúc lớn.
