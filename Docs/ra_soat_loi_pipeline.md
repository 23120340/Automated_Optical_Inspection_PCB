...
**File:** `aoi_pipeline/exporters.py` — `solder_joints_csv`, `solder_verdicts_csv`,
`cad_findings_csv`
...
**File:** `aoi_pipeline/digitizer.py:834` (`_safe_csv_text`),
...
**File:** `models/active/solder/segmenter/`, `aoi_pipeline/model_registry.py:57`
...
**File:** `aoi_pipeline/model_registry.py:119` (`_HEADLINE_METRICS`)
...
**File:** `aoi_pipeline/model_registry.py:455` (`_TASK_TO_KIND`),
