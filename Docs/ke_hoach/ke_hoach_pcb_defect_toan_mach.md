...
- **Ô model:** thêm `board_anomaly` vào `STAGE_FOLDERS`/`_MODEL_SLOTS` trong
  `app/streamlit_app.py` và `aoi_pipeline/modelops/model_registry.py`. Nhớ: registry chỉ
...
Xem thêm: `Docs/ke_hoach/ke_hoach_phan_nhom_package.md`,
`Docs/bao_cao/tien_do_detect_2_luot.md`, `Docs/danh_gia/danh_gia_model_6_2.md`,
