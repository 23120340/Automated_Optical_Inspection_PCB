...
> Tài liệu dữ liệu liên quan: [Khảo sát dataset PCB AOI](../khao_sat/pcb_aoi_component_datasets.md) | [Kế hoạch ứng dụng RNN/LSTM](ke_hoach_ung_dung_rnn_lstm_aoi_pcb.md) | [Kế hoạch số hóa mạch PCB](ke_hoach_so_hoa_mach_pcb_aoi.md) | [Báo cáo tiến độ](../bao_cao/bao_cao_tien_do.md)
