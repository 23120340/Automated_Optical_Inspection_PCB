...
> Tài liệu liên quan: [Định dạng CAD hỗ trợ](../thiet_ke/cad_formats.md) | [Detect mối hàn 2 giai đoạn](ke_hoach_detect_moi_han_2_giai_doan.md) | [Kế hoạch RNN/LSTM](ke_hoach_ung_dung_rnn_lstm_aoi_pcb.md) | [Kế hoạch phân loại 6.1](ke_hoach_pretrain_6_1_classification.md)
...
* Xuất thẳng ra các định dạng chuẩn công nghiệp: `pads_csv` (tương thích ngay với [`Docs/thiet_ke/cad_formats.md`](../thiet_ke/cad_formats.md)), `placement_csv`, `IPC-356` và `recipe.json` cho Golden Inspection.
...
Tương thích 100% với trình nạp CAD sẵn có trong [`Docs/thiet_ke/cad_formats.md`](../thiet_ke/cad_formats.md):
