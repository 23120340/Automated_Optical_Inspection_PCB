...
> rõ là chưa đo.
>
> Thay thế thứ tự P0→P5 trong `Docs/phuong_an_sua_roi_moi_han_v2.md`. Tài liệu
...
- Nguồn nhãn: **mục "Đánh giá model" đã có sẵn**. Từ vựng bước `solder` trong
  `aoi_pipeline/model_feedback.py:89` đã đúng thứ cần: `roi_misplaced` (ROI sai
...
Theo đúng `Docs/ke_hoach_fine_tune_cuc_bo.md`, không viết lại. Ba phép đo hỏng ở
