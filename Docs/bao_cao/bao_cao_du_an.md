...
> **Tài liệu tham chiếu:** Thiết kế hệ thống, Thực nghiệm mã nguồn ([`aoi_pipeline/`](../../aoi_pipeline/)), Báo cáo tiến độ ([`Docs/bao_cao/bao_cao_tien_do.md`](../../Docs/bao_cao/bao_cao_tien_do.md)), Hướng dẫn huấn luyện ([`training/kaggle/`](../../training/kaggle/)), và Nghiên cứu phân cực linh kiện.  
