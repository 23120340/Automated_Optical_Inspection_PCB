...
| nội dung | file |
|---|---|
| Phân nhóm package (luật, chốt an toàn, cổng, các phép đo) | [ke_hoach_phan_nhom_package.md](../../ke_hoach/ke_hoach_phan_nhom_package.md) |
| Golden ghép sơ đồ + quy trình chụp bo | [ke_hoach_golden_ghep_so_do.md](../../ke_hoach/ke_hoach_golden_ghep_so_do.md) |
| Detect mối hàn 2 lượt (bảng công việc) | [tien_do_detect_2_luot.md](../tien_do_detect_2_luot.md) |
| Đánh giá classifier 6.1 | [danh_gia_classifier_6_1.md](../../danh_gia/danh_gia_classifier_6_1.md) |
